...
## Introduction
SCOOP stands for Scalable or Sectoral Carbon Offset Open Platform.  It is an evolution of an [IT platform initially targeted at the financialization of carbon offsets]().
This initial exploration work suggested that the platform requires a flexible architecture to keep pace with the understanding of GHG dynamics. A GHG mitigation strategy solely focused on offsetting faces three fundamental issues, namely,
